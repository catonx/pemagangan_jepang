...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Jul 2018 pada 12.25
...
--
-- Struktur dari tabel `hasil_fisik`
--
...
--
-- Dumping data untuk tabel `hasil_fisik`
--
...
--
-- Struktur dari tabel `hasil_kesemaptaan`
--
...
--
-- Dumping data untuk tabel `hasil_kesemaptaan`
--
...
(10, '28', 'Desember', '2017', 'Lampung', 'Ya'),
...
CREATE TABLE `member` (
  ...
  `provinsi` varchar(100) NOT NULL,
  `th_pelaksanaan` varchar(4) NOT NULL,
  `id_jadwal` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data untuk tabel `tes_fisik`
--
...
--
-- Struktur dari tabel `tes_kesemaptaan`
--
...
--
-- Dumping data untuk tabel `tes_kesemaptaan`
--
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'yanuar', 'yanuar.adhi.nugroho@gmail.com', '085643707015', '2018-05-19 23:15:22'),
